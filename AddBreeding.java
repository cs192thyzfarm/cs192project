 ...
 * @author Ukz
 */
public class AddBreeding extends javax.swing.JFrame {

    /**
     * Creates new form AddBreeding
     */
    public AddBreeding() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        addButchText.setText("                            Add Breeding Item");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBreeding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new AddBreeding().setVisible(true);
            }
        });
    }
