 ...
 * AddButchered.java
 *
 * Created on Feb 4, 2012, 10:14:58 AM
 */
/**
 *
 * @author shainey
 */
public class AddButchered extends javax.swing.JFrame {

    /** Creates new form AddButchered */
    public AddButchered() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        addButchText.setFont(new java.awt.Font("Verdana", 1, 24));
        addButchText.setText("                      Add Butchered Sales Item");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddButchered.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new AddButchered().setVisible(true);
            }
        });
    }
